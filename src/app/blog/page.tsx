    ...
    <main className="relative min-h-screen py-16 md:py-24">
      <div className="max-w-[96rem] mx-auto px-6 md:px-10 space-y-16">
        <header className="space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-display leading-[1.05] bg-gradient-to-r from-cyan-600 via-black to-cyan-600 bg-clip-text text-transparent">
