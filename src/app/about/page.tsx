        ...
        <div className="max-w-[96rem] mx-auto px-6 md:px-8">
              ...
              <div data-animate="fade-up" data-delay="0.2" className="group">
                <div className="space-y-6">
                  <div className="space-y-6 text-charcoal/80 text-lg md:text-2xl lg:text-2xl leading-relaxed">
                    <p>
                      I&apos;m a frontend web developer who believes that great
                      user experiences are born from the intersection of
                      beautiful design and performant code. My journey started
                      with curiosity about how websites work, and it has evolved
                      into a passion for creating digital experiences that feel
                      both functional and magical.
                    </p>
                    <p>
                      When I&apos;m not crafting interfaces, you&apos;ll find me
                      exploring new web technologies, contributing to open
                      source, or enjoying a good cup of coffee while sketching
            ...
            <div className="lg:col-span-5">
              ...
              >
                <div className="relative" data-tech-orbit>
                  <div
                    data-orbit-center
                    className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 group z-10"
                  >
                    ...
                    <div className="relative w-full h-full rounded-full bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900 border border-gray-600/50 shadow-xl flex items-center justify-center transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl">
                      ...
                      <div className="relative z-10 w-8 h-8 flex items-center justify-center">
                        ...
                        />
                        <div
                          className="absolute inset-1 border border-blue-400/20 rounded-full animate-spin"
          ...
          >
            <div className="text-center space-y-8">
              <h3
                className="font-display text-charcoal text-4xl md:text-5xl lg:text-6xl font-light mb-12"
                data-drives-title
              >
                What Drives Me
              </h3>
              <div className="flex items-center justify-center">
                <div
                  className="flex-1 h-px bg-gradient-to-r from-transparent via-charcoal/40 to-charcoal/60"
                  data-drives-line-left
                />
                <div className="px-6">
                  <div
                    className="w-2 h-2 rounded-full bg-charcoal/70 shadow-sm"
                    data-drives-dot
                  />
                </div>
                <div
                  className="flex-1 h-px bg-gradient-to-l from-transparent via-charcoal/40 to-charcoal/60"
                  data-drives-line-right
                />
              </div>
            </div>

            <div
              className="max-w-6xl mx-auto space-y-16 lg:space-y-20"
              data-drives-container
            >
              {/* Item 01 */}
              <div
                className={driveItemClasses}
                data-drives-item="1"
                data-magnetic
              >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    <div className="lg:col-span-5 space-y-6">
                      <div className="flex items-center gap-6">
                        <div className="relative drives-number">
                          <span className="font-display text-6xl md:text-7xl lg:text-8xl font-light text-charcoal/20">
                            01
                          </span>
                          <div className="absolute inset-0 font-display text-6xl md:text-7xl lg:text-8xl font-light bg-gradient-to-br from-cyan-400 to-blue-500 bg-clip-text text-transparent opacity-0 drives-number-gradient">
                            01
                          </div>
                        </div>
                        <div className="w-px h-16 bg-charcoal/20 drives-divider" />
                        <div className="space-y-2">
                          <h4 className="font-display text-2xl md:text-3xl lg:text-4xl text-charcoal drives-title">
                            Problem Solving
                          </h4>
                    ...
                    <div className="lg:col-span-7">
                      <p className="text-charcoal/70 text-lg md:text-xl lg:text-2xl leading-relaxed drives-description">
                        Every project is a puzzle waiting to be solved. I thrive
                        on breaking down complex challenges into manageable
                        solutions, finding elegant ways to turn ideas into
                        reality through thoughtful architecture and innovative
                        thinking.
                      </p>
                    </div>
                  </div>
                ...
                <div className="py-8 md:py-12">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    <div className="lg:col-span-7 order-2 lg:order-1">
                      <p className="text-charcoal/70 text-lg md:text-xl lg:text-2xl leading-relaxed drives-description">
                        Technology evolves rapidly, and staying curious keeps me
                        ahead. Whether it&apos;s exploring new frameworks,
                        design patterns, or emerging web standards, I&apos;m
                        always expanding my toolkit to deliver better solutions.
                      </p>
                    </div>
                    <div className="lg:col-span-5 order-1 lg:order-2">
                      <div className="flex items-center gap-6 justify-end lg:justify-start flex-row-reverse lg:flex-row">
                        ...
                        <div className="relative drives-number">
                          ...
                          <div className="absolute inset-0 font-display text-6xl md:text-7xl lg:text-8xl font-light bg-gradient-to-br from-emerald-400 to-teal-500 bg-clip-text text-transparent opacity-0 drives-number-gradient">
                            02
                          </div>
                        </div>
                      </div>
              ...
              >
                <div className="py-8 md:py-12">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    <div className="lg:col-span-5 space-y-6">
                      <div className="flex items-center gap-6">
                        <div className="relative drives-number">
                          ...
                          <div className="absolute inset-0 font-display text-6xl md:text-7xl lg:text-8xl font-light bg-gradient-to-br from-purple-400 to-pink-500 bg-clip-text text-transparent opacity-0 drives-number-gradient">
                            03
                          </div>
                        </div>
                        <div className="w-px h-16 bg-charcoal/20 drives-divider" />
                    ...
                    <div className="lg:col-span-7">
                      <p className="text-charcoal/70 text-lg md:text-xl lg:text-2xl leading-relaxed drives-description">
                        Behind every click is a real person with real needs.
                        I&apos;m passionate about creating experiences that make
                        people&apos;s lives easier, more productive, and more
                        enjoyable. User satisfaction is my ultimate success
                        metric.
                      </p>
                    </div>
                  </div>
